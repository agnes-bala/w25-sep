  ...
  //   const [total, setTotal] = useState(200); // Start with base amount ₹200
  ...
  //   const MAX_DISCOUNT_PERCENTAGE = 100; // Maximum discount percentage allowed
  //   const DISCOUNT_PASSWORD = 'admin123'; // Password for applying discount
  ...
  //       return Math.min(percentageDiscount, totalAmount); // Ensure discount doesn't exceed total
  //     }
  //     return Math.min(discountValue, totalAmount); // For fixed amount, ensure it doesn't exceed total
  //   };
  ...
  //     city: '',
  //     pincode: '',
  //     paymentMode: 'cash', // Default payment mode set to cash
  //     upiRefNumber: '',
  //     memberList: [],
  //     isAttended: 'yes',
  //     discount: 0,
  ...
  //     discountBy: '',
  //     amount: 200, // Start with base amount ₹200
  //     discountPassword: '',
  ...
  //     city: string;
  //     pincode: string;
  //     // Remove old fields (kept for backward compatibility)
  //     // extraMale: number;
  //     extraChild: number;
  //     // New age-based fields
  //     under: number;
  ...
  //   // Watch payment mode to show/hide UPI reference field
  ...
  //       setValue('upiRefNumber', ''); // Clear UPI reference when not UPI
  //     }
  ...
  //       discountType: 'fixed',
  //       discountBy: '',
  //       paymentMode: 'cash', // Reset to default cash
  //       upiRefNumber: '',
  //       amount: 200, // Reset to base amount ₹200
  //       discountPassword: '',
  //       textReminderConsent: true,
  //       addr1: '',
  //       addr2: '',
  ...
  //     setTotal(baseAmount); // Reset total to calculated base amount
  //     setValue('amount', baseAmount); // Ensure form field is also updated
  ...
  //   // Initialize amount calculation on component mount
  //   useEffect(() => {
  ...
  //       // Reset discount when hiding fields
  //       setValue('discount', 0);
  ...
  //     // Check if isAttended is "yes"
  //     if (result.isAttended === 'yes') {
  //       setIsAttendedYes(true);
  //       // Show popup dialog instead of just toast
  ...
  //     // For backward compatibility, we'll set default values for age-based fields
  //     // since the old data doesn't have age breakdown
  //     const childMale = parseInt(result.childMale) || 0;
  //     const extraFemale = parseInt(result.extraFemale) || 0;
  //     const childFemale = parseInt(result.childFemale) || 0;
  //     const under = parseInt(result.under) || 0;

  //     // Distribute old data into new age-based fields (you might need to adjust this logic)
  //     setValue('maleChild', childMale); // Assume all males are 7-14 for backward compatibility
  //     setValue('extraFemale', extraFemale); // Assume all females are above 14 for backward compatibility
  //     setValue('femaleChild', childFemale); // Assume children are female 7-14 for backward compatibility
  //     setValue('under', under); // Set under to 0 for backward compatibility

  //     const calculatedAmount = calculateAmount({
  //       under: 0,
  //       maleChild: childMale,
  //       femaleChild: childFemale,
  ...
  //     // Fill the form with the selected result data
  ...
  //     // Update states and districts based on country and state
  ...
  //     setSearchDialogOpen(false);
  //     setSearchQuery('');
  //     toast.success('Form filled with selected partner data');
  //   };

  //   const created_by = user?.name || 'Unknown';

  //   const onSubmit = handleSubmit(async (data) => {
  //     // If isAttended is yes, don't submit the form
  //     if (isAttendedYes) {
  ...
  //       // Age-based member counts as strings to match your desired output
  ...
  //     try {
  //       const response = await fetch(`${config.BASE_URL}/addData`, {
  //         method: "POST",
  //         headers: {
  ...
  //                   Created by: {selectedResult.createdBy}
  //                 </Typography>
  //               ) : null
  //             }
  //           /> */}
  ...
  //           {/* Show message when isAttended is yes */}
  //           {isAttendedYes && selectedResult && (
  //             <Box sx={{ px: 2, py: 0.5 }}>
  ...
  //                             )}
  //                             <Typography variant="body2" component="span">
  //                               Extra Members: Male({result.childMale}), Female({result.childFemale}), Child({result.under})
  //                             </Typography>
  //                             <br />
  //                             <Typography variant="body2" component="span" fontWeight="bold">
  //                               Total Amount: ₹{calculateAmount({
  //                                 under: 0,
  //                                 maleChild: parseInt(result.childMale) || 0,
  //                                 femaleChild: parseInt(result.childFemale) || 0,
